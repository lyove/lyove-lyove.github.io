...
class Rr {
  ...
  createElement(t, { attributes: e = {}, html: r = "" } = {}) {
    ...
    return i.innerHTML = r, Object.entries(e).forEach(
      ([o, n]) => n && i.setAttribute(o, `${n}`)
    ), i;
  }
  insert(t) {
    var r;
    ...
    if (e instanceof HTMLSlotElement && this.editor.tags.allowed(e.parentElement, t))
      ...
      (r = this.closest(e, t)) == null || r.insertAdjacentElement(
        I.AFTEREND,
        t
      ), e.hasAttribute("data-deletable") && !e.textContent.trim() && e.parentElement.removeChild(e);
...
st = new WeakMap(), nt = new WeakSet(), he = function(t, e, r) {
  e instanceof HTMLElement && r instanceof HTMLElement && (this.dispatch(t, e, r), this.dispatch(
    `${t}${e.localName.replace("-", "")}`,
    e,
    r
  ));
...
class y {
  ...
  execute(t, e) {
    ...
    if (this.dropdown) {
      const o = this.editor.element.getElementsByTagName(
        s.DROPDOWN
      );
      if (o.length > 0) {
  ...
  insert(t = {}) {
    if (!!this.tag)
      if (m(this, Ct, Ye).call(this, t), this.tag.group === u.FORMAT) {
        const e = this.editor.dom.getSelectedElementByName(
          this.tag.name
        );
        if (e) {
          const r = this.editor.dom.createText(
            e.textContent
          );
        ...
        this.editor.dom.insert(
          this.editor.dom.createElement(this.tag.name, { attributes: t })
        );
  }
  openDialog(t) {
    var e;
    (e = this.dialog) == null || e.open(
      (r) => this.insert(r),
      m(this, at, ue).call(this)
    );
  }
  openDropdown(t, e) {
    var r;
...
Et = new WeakMap(), Lt = new WeakMap(), Tt = new WeakMap(), xt = new WeakMap(), Mt = new WeakMap(), at = new WeakSet(), ue = function(t) {
  ...
  const e = this.editor.dom.getSelectedAttributesByName(
    this.tag.name,
    t
  );
  ...
  t.length > 0 && Array.from(t).forEach((e) => {
    ...
    if (r) {
      ...
      const { command: i } = e.dataset, o = r.querySelector(
        `button[data-command=${i}]`
      ), n = Array.from(o.children).find(
...
class si {
  ...
  find(t) {
    return Array.from(l(this, z).values()).find(
      (e) => {
        var r;
...
class f {
  ...
  _i18n(t) {
    t[this.editor.config.lang] && this.editor.translator.set(
      this.constructor.name,
      t[this.editor.config.lang]
    );
  }
  _tag(t) {
  ...
  _command(t) {
    this.editor.commands.set(
      new y(this.editor, this.constructor.name, t)
    );
  }
...
class li {
  ...
  addLegend(t) {
    if (!x(t))
      throw new Error(k.INVALID_ARGUMENT);
    return l(this, P).appendChild(
      l(this, R).createElement(s.LEGEND, { html: t })
    ), this;
  }
  addTextInput(t, e, r = {}) {
...
class D {
  ...
  cleanup() {
    Array.from(
      this.editor.element.getElementsByTagName(s.DIALOG)
    ).forEach((t) => {
...
class fi extends C {
  ...
  keydown(t) {
    ...
    if (_(t, d.ENTER, { shift: !0 }) && !this.editor.tags.allowed(t.target, s.BR))
      ...
      n && (t.target.textContent.trim() || !t.target.hasAttribute("data-deletable") ? (r = this.editor.dom.closest(t.target, n)) == null || r.insertAdjacentElement(
        I.AFTEREND,
        this.editor.dom.createElement(n)
      ) : t.target instanceof HTMLParagraphElement || ((i = this.editor.dom.closest(t.target, s.P)) == null || i.insertAdjacentElement(
        I.AFTEREND,
        this.editor.dom.createElement(s.P)
...
class bi extends qe {
  constructor(e) {
    ...
    const o = Array.from(r.children).find(
      (c) => c.className === "trigger"
    ), n = Array.from(r.children).find(
...
Qt = new WeakSet(), tr = function(e) {
  ...
  e.hidden = !0, e.removeAttribute("style"), Object.keys(e.dataset).forEach(
    (r) => delete e.dataset[r]
  );
};
var ze, Fr, Ve, Ur;
class ki extends qe {
...
class Li extends C {
  ...
  insert(t) {
    t.detail.element instanceof HTMLSlotElement ? t.detail.element.addEventListener("keydown", this) : t.detail.element.hasAttribute("data-slotable") && !t.detail.element.querySelector(":scope > " + s.SLOT) && t.detail.element.appendChild(
      this.editor.dom.createElement(s.SLOT)
    );
  }
  keydown(t) {
...
class Ti extends C {
  ...
  pointerup(e) {
    ...
    if (r && this.editor.dom.contains(r)) {
      const i = this.editor.dom.document.elementFromPoint(
        e.x,
        e.y
      );
...
class Mi extends C {
  constructor(t) {
    super(t), this.editor.dom.document.addEventListener("selectionchange", this), this.editor.textarea.addEventListener(
      "input",
  ...
  delete(t) {
    var r, i;
    const { onValueChange: e } = this.editor.config;
    typeof e == "function" && e((r = t == null ? void 0 : t.currentTarget) == null ? void 0 : r.innerHTML, t), ((i = t == null ? void 0 : t.currentTarget) == null ? void 0 : i.innerHTML) === "" && this.editor.textarea.appendChild(
      this.editor.dom.createElement(s.P)
    );
  }
  keydown(t) {
...
class Ii extends it {
  ...
  filter(e) {
    ...
    let n = [];
    const c = (g = null) => {
      i && n.length > 0 && (e.insertBefore(
        this.editor.dom.createElement(s.P, { html: n.join(" ") }),
        g
      ), n = []);
    };
...
class vi extends HTMLElement {
  ...
  constructor() {
    super(), this.addEventListener(
      "keydown",
      (t) => t.key === d.ESC && this.close()
    ), this.addEventListener(
      "click",
      (t) => t.target === this && this.close()
    );
  }
  connectedCallback() {
  ...
  close() {
    this.open = !1, this.dispatchEvent(
      new CustomEvent("close", { detail: { element: this, target: this } })
    );
  }
}
class _i extends HTMLElement {
  ...
  show(t, e) {
    ...
    const r = e.getBoundingClientRect(), i = t.getBoundingClientRect(), { left: o, top: n } = r, {
      left: c,
      top: g,
      width: p,
      height: L
...
`);
    ...
    t.innerHTML = t.innerHTML.replace(/^\s*(<br\s*\/?>\s*)+/gi, "").replace(/\s*(<br\s*\/?>\s*)+$/gi, ""), t instanceof HTMLParagraphElement ? t.outerHTML = t.outerHTML.replace(
      /\s*(<br\s*\/?>\s*){2,}/gi,
      "</p><p>"
...
class Ri extends C {
  ...
  paste(e) {
    this.editor.dom.window.setTimeout(
      () => this.editor.filters.filter(e.target)
    );
  }
}
...
class we extends f {
  ...
  init() {
    this._i18n(zi), this._toolbar({
      ...
      arrowDown: O["arrow-down"],
      uuid: rt()
    }), this.editor.dropdowns.set(new ji(this.editor)), this.editor.commands.set(
      new Si(this.editor, u.FONTSIZE)
    );
  }
}
var re, nr;
class Vi extends C {
  ...
  insertol(e) {
    e.detail.element.children.length === 0 && e.detail.element.appendChild(
      this.editor.dom.createElement(s.LI)
    );
  }
  insertul(e) {
    this.insertol(e);
...
class be extends f {
  ...
  init() {
    this._i18n(Xi), this._toolbar({
      ...
      arrowDown: O["arrow-down"],
      uuid: rt()
    }), this.editor.dropdowns.set(new Ki(this.editor)), this.editor.commands.set(
      new Qi(this.editor, u.LINEHEIGHT)
    );
  }
}
class Yi extends it {
...
class ke extends f {
  ...
  init() {
    this._i18n(ro), this._toolbar({
      ...
      arrowDown: O["arrow-down"],
      uuid: rt()
    }), this.editor.dropdowns.set(new to(this.editor)), this.editor.commands.set(
      new eo(this.editor, this.constructor.name, u.COLOR)
    );
  }
}
class io extends W {
...
class co extends C {
  ...
  insertfigure(t) {
    t.detail.element.querySelector(":scope > " + s.FIGCAPTION) || t.detail.element.appendChild(
      this.editor.dom.createElement(s.FIGCAPTION)
    );
  }
}
class Ze extends f {
...
class Le extends f {
  ...
  init() {
    ...
    this._i18n(ho), this._tag({
      ...
      new no(
        this.editor,
        (e = (t = this.editor.config.customPlugins) == null ? void 0 : t.image) == null ? void 0 : e.browser
      )
...
class mo extends C {
  ...
  sethtml(e) {
    Array.from(
      e.detail.element.getElementsByTagName(s.VIDEO)
    ).forEach((r) => m(this, oe, hr).call(this, r));
  }
  insertvideo(e) {
...
class Te extends f {
  ...
  init() {
    ...
    this._i18n(go), this._tag({
      ...
      new uo(
        this.editor,
        (e = (t = this.editor.config.customPlugins) == null ? void 0 : t.video) == null ? void 0 : e.browser
      )
...
class fo extends C {
  ...
  sethtml(e) {
    Array.from(
      e.detail.element.getElementsByTagName(s.AUDIO)
    ).forEach((r) => m(this, se, ur).call(this, r));
  }
  insertaudio(e) {
...
class xe extends f {
  ...
  init() {
    ...
    this._i18n(wo), this._tag({
      ...
      new po(
        this.editor,
        (e = (t = this.editor.config.customPlugins) == null ? void 0 : t.audio) == null ? void 0 : e.browser
      )
...
class Eo extends it {
  filter(t) {
    ...
    ), t.parentElement.removeChild(t)) : (t instanceof HTMLTableElement && t.querySelector(
      `:scope > ${s.THEAD}, :scope > ${s.TFOOT}`
    ) && !t.querySelector(":scope > " + s.TBODY) || t instanceof HTMLTableSectionElement && t.rows.length <= 0 || t instanceof HTMLTableRowElement && !t.querySelector(
...
class Lo extends C {
  ...
  keydown(e) {
    ...
    if (r instanceof HTMLTableCellElement && i instanceof HTMLTableRowElement && (o instanceof HTMLTableElement || o instanceof HTMLTableSectionElement) && n instanceof HTMLTableElement && (g && m(this, Pe, Wr).call(this, r, e.key) || p || L || M)) {
      ...
      e.preventDefault(), e.stopPropagation(), g ? e.key === d.LEFT && !mt ? this.editor.dom.focusEnd(i.cells[E - 1]) : e.key === d.LEFT && Tr ? this.editor.dom.focusEnd(
        n.rows[n.rows.length - 1].cells[A - 1]
      ) : e.key === d.LEFT ? this.editor.dom.focusEnd(
        n.rows[i.rowIndex - 1].cells[A - 1]
      ) : e.key === d.RIGHT && !Ke ? i.cells[E + 1].focus() : e.key === d.RIGHT && xr ? n.rows[0].cells[0].focus() : e.key === d.RIGHT ? n.rows[i.rowIndex + 1].cells[0].focus() : e.key === d.UP && Tr ? n.rows[n.rows.length - 1].cells[E].focus() : e.key === d.UP ? n.rows[i.rowIndex - 1].cells[E].focus() : e.key === d.DOWN && xr ? n.rows[0].cells[E].focus() : e.key === d.DOWN && n.rows[i.rowIndex + 1].cells[E].focus() : p ? (e.key === d.LEFT && A > 1 && mt ? Array.from(n.rows).forEach(
        (T) => T.appendChild(T.cells[E])
      ) : e.key === d.LEFT && A > 1 ? Array.from(n.rows).forEach(
      ...
      ) : e.key === d.UP && j > 1 && Jr ? o.appendChild(i) : e.key === d.UP && j > 1 ? o.insertBefore(i, o.rows[N - 1]) : e.key === d.DOWN && j > 1 && ti ? o.insertBefore(i, o.rows[0]) : e.key === d.DOWN && j > 1 && o.insertBefore(o.rows[N + 1], i), r.focus()) : L ? e.key === d.LEFT ? Array.from(n.rows).forEach(
        (T) => m(this, ht, ge).call(this, T, T.cells[E])
      ) : e.key === d.RIGHT ? Array.from(n.rows).forEach(
        (T) => m(this, ht, ge).call(this, T, T.cells[E + 1])
      ) : e.key === d.UP ? m(this, tt, pt).call(this, o, A, N) : e.key === d.DOWN && m(this, tt, pt).call(this, o, A, N + 1) : M && (e.key === d.LEFT && !mt ? Array.from(n.rows).forEach(
        (T) => T.deleteCell(E - 1)
      ) : e.key === d.RIGHT && !Ke ? Array.from(n.rows).forEach(
        (T) => T.deleteCell(E + 1)
      ) : e.key === d.UP && N > 0 ? o.deleteRow(N - 1) : e.key === d.DOWN && N < j - 1 && o.deleteRow(N + 1));
    }
  }
}
...
class et extends f {
  ...
  init() {
    ...
    }), this._tag(m(this, ne, mr).call(this, s.TH)), this._tag(m(this, ne, mr).call(this, s.TD)), new Lo(this.editor), this.editor.filters.add(new Eo(this.editor)), this.editor.dialogs.set(new ko(this.editor)), this.editor.commands.set(
      new bo(this.editor, this.constructor.name, s.TABLE)
    ), this._toolbar({
      label: this._("Table"),
      command: this.constructor.name
    });
...
class Ho extends C {
  ...
  sethtml(t) {
    Array.from(
      t.detail.element.getElementsByTagName(s.BLOCK)
    ).forEach(
...
class Zr extends f {
  ...
  init() {
    ...
    this._i18n(qr), this.editor.dom.registerElement(s.BLOCK, _o), this._tag({
      ...
      new vo(
        this.editor,
        (e = (t = this.editor.config.customPlugins) == null ? void 0 : t.block) == null ? void 0 : e.browser
      )
...
class Ro extends C {
  ...
  sethtml(e) {
    Array.from(
      e.detail.element.getElementsByTagName(s.IFRAME)
    ).forEach((r) => m(this, ae, gr).call(this, r));
  }
  insertiframe(e) {
...
class Lr extends f {
  ...
  init() {
    ...
    this._i18n(qr), this._tag({
      ...
      new No(
        this.editor,
        (e = (t = this.editor.config.customPlugins) == null ? void 0 : t.iframe) == null ? void 0 : e.browser
      )
...
de = new WeakSet(), pr = function(e) {
  ...
  r ? e.setAttribute("href", this.editor.url(r)) : e.parentElement.replaceChild(
    this.editor.dom.createText(e.textContent),
    e
  );
};
const zo = {
